...
var TestInput = React.createClass({
  ...
  addValue: function () {
    console.log(this.state.field_value);
  },
  render: function() {
    ...
    return (
      <div>
        <input onChange={changeField} className='test-input' value={value} placeholder='введите значение' />
        <button onClick={addValue}>Добавить значение</button>
      </div>
    );
  }
});
