...
var Add = React.createClass({
  ...
  onCheckRuleClick: function(e) {
    ReactDOM.findDOMNode(this.refs.checkrule).checked = true;
  ...
  onBtnClickHandler: function(e) {
     ...
     var item = [{
         author: author,
         text: text,
         bigText: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam tempora esse id officiis architecto corporis, alias temporibus cum eum amet, asperiores aspernatur. Impedit pariatur debitis eveniet harum fugiat, tenetur quisquam.'
       }];
    window.ee.emit('News.add', item);
    ReactDOM.findDOMNode(this.refs.author).value = '';
    ReactDOM.findDOMNode(this.refs.text).value = '';
    ReactDOM.findDOMNode(this.refs.checkrule).checked = false;
    console.log(author+' :\n'+text);
  },
  onCheckRuleClick: function(e) {
    // this.setState({ agreeNotChecked: true });
      ...
      <form className='add cf'>
        ...
        <label className='add__checkrule'>
          <input
            type='checkbox'
            ref='checkrule'
            onChange={this.onCheckRuleClick} defaultChecked=''/>
